...
<head>
    ...
    <link rel="stylesheet" href="member_assets/vendor/owl-carousel/css/owl.carousel.min.css">
    <link rel="stylesheet" href="member_assets/vendor/owl-carousel/css/owl.theme.default.min.css">
    <link href="member_assets/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
...
<body>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="<?php echo base_url(); ?>user_login" class="dropdown-item">
                                        <i class="icon-key"></i>
                                        ...
                                        <div class="item">
                                            <div class="testimonial-content">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <img class="testimonial-author-img ml-3" src="member_assets/images/avatar/1.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="item">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href="#"><img width="35" src="member_assets/images/avatar/1.png" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>Lew Shawon</td>
    ...
    ***********************************-->
    ...
    <!-- Vectormap -->
    <script src="member_assets/vendor/raphael/raphael.min.js"></script>
    <script src="member_assets/vendor/morris/morris.min.js"></script>


    <script src="member_assets/vendor/circle-progress/circle-progress.min.js"></script>
    <script src="member_assets/vendor/chart.js/Chart.bundle.min.js"></script>

    <script src="member_assets/vendor/gaugeJS/dist/gauge.min.js"></script>

    <!--  flot-chart js -->
    <script src="member_assets/vendor/flot/jquery.flot.js"></script>
    <script src="member_assets/vendor/flot/jquery.flot.resize.js"></script>

    <!-- Owl Carousel -->
    <script src="member_assets/vendor/owl-carousel/js/owl.carousel.min.js"></script>

    <!-- Counter Up -->
    <script src="member_assets/vendor/jqvmap/js/jquery.vmap.min.js"></script>
    <script src="member_assets/vendor/jqvmap/js/jquery.vmap.usa.js"></script>
    <script src="member_assets/vendor/jquery.counterup/jquery.counterup.min.js"></script>


    <script src="member_assets/js/dashboard/dashboard-1.js"></script>
