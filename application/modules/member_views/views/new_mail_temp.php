                        ...
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                              <td align="center">
                                 ...
                                 Thank you for Member Ship With NU CLUB <br>
                                 Now Your an NU PRENEUR
                                <br>
                                All the Best for Yur Bright Boards
                            </font></a>
                              </td>
                              <td align="right">
                                 <!--[endif]--><!--
                                    ...
                                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                       <tr>
                                          <td>
                                             ...
                                             NU PRENEUR ID:<?php echo $member_code; ?><br/>
                                             Password:<?php echo $password; ?><br/>
                                             NU POINTS:<?php echo $points; ?>
                                 ...
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td align="center" style="padding:20px;flaot:left;width:100%; text-align:center;">
                                          ...
                                          <a href="https://www.nuclubindia.com/user_login" target="_blank" class="btn btn-danger block-center">
                                             www.nuclubindia.com/user_login
                                                </a>
                                          </span></font>
                                       </td>
                                    </tr>
