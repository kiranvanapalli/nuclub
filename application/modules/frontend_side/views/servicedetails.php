                    ...
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5">
                        ...
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                                ...
                                <li class="list-inline-item breadcrumb-item"><a href="Services.html">Services</a></li>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="service-details-wrap">
                        <img src="user_assets/new-assets/images/slider-img-2.jpg" alt="services" class="img-fluid rounded shadow-sm">
                        <div class="services-detail-content mt-4">
                            ...
                            <div class="row mt-5">
                                <div class="col-md-6">
                                    <div class="img-wrap">
                                        <img src="user_assets/new-assets/images/images.jpg" alt="services" class="img-fluid">
                                    </div>
                                </div>
                                <div class="col-md-6">
