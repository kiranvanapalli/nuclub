            ...
            <div class="col-md-8 col-lg-8  mt-5 pt-5 mb-5">
                <div class="card login-signup-card shadow-lg mb-0">
                    <div class="px-md-5 py-3 p-4">
                        <!--login form-->
                        <form class="login-signup-form" name="ref_form" id="ref_form" method="POST" autocomplete="off">
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    <div class="input-group input-group-merge">
                                        <div class="input-icon">
                                            <span class="icofont-id-card color-primary"></span>
                                        </div>
                                        <input type="text" class="form-control" placeholder="Enter Your Referrals ID" name="ref_code" id="ref_code" value="Referral Code: <?php echo $get_member_details['member_nucode'];; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Your Name" name="fullname" id="fullname" value="<?php echo $get_member_details['fullname']; ?>">
                                    </div>
                                </div>
                                <div class="form-group col-lg-6">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Mobile Number" name="mobilenumber" id="mobilenumber" onkeypress="return onlyNumberKey(event)" maxlength="10" value="<?php echo $get_member_details['mobilenumber']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-5">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="email" class="form-control" placeholder="name@yourdomain.com" name="email" id="email" value="<?php echo $get_member_details['email']; ?>" readonly>
                                    </div>
                                </div>
