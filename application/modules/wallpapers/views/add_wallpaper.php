<div class="app-content content">
   <div class="content-wrapper">
      <div class="content-body">
         ...
         <div class="row">
            <div class="col-12">
               <form action="" class="form" name="add_wallpaper_form" id="add_wallpaper_form" autocomplete="off">
                  <div class="row">
                  <div class="col-6 form__img">
                <label for="form__img-upload" class="label_name"></label>
                <input id="form__img-upload" name="wallpaper_img" class="wallpaper_img" type="file" accept=".png, .jpg, .jpeg" onchange="previewFile(this);">
